...
def expected_sessions(fp):
    ...
    feuille « Vista profesor » corrigée doit reproduire.
    """
...
def subject_professor_weights(fp):
    """
...
def assign_schedule_groups(fp, subject_to_groups):
    """
